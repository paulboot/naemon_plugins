...
# Globals
ingnoredepartments = ['Apotheek', 'Dialyse', 'Cardio Research', 'Cardiologie Planning', 'Laboratorium', 'Logopedie']
        ...
        for element in xml.iter():
            if element.tag == 'title' and element.text !='Uitloop':
                ...
                if searchObj:
                    ...
                    if departmentname not in ingnoredepartments:
...
def main():
    ...
    check = nagiosplugin.Check(
        ...
        nagiosplugin.ScalarContext('aantaluitloopafdelingen', args.warning, args.critical, fmt_metric='{value} maximale uitloop in minuten'),
